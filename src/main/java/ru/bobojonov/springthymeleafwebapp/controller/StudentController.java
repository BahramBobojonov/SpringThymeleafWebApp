package ru.bobojonov.springthymeleafwebapp.controller;
...
import ru.bobojonov.springthymeleafwebapp.dao.StudentRepository;
...
public class StudentController {
    ...
    public ModelAndView addStudentForm() {
        ...
        mav.addObject("student", student);  // Измените "students" на "student"
        return mav;
    }
